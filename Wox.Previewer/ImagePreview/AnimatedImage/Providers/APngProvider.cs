...
namespace QuickLook.Plugin.ImageViewer.AnimatedImage.Providers
{
    internal class APngProvider : AnimationProvider
    {
        ...
        public APngProvider(Uri path, MetaProvider meta) : base(path, meta)
        {
            ...
            foreach(var _ in Enumerable.Repeat(0, decoder.Frames.Length))
            {
                _renderedFrames.Add(null);
            }
            ...
            using (var context = visual.RenderOpen())
            {
                ...
                if (currentFrame.BlendOp == BlendOps.APNGBlendOpSource)
                {
                    ...
                    context.PushOpacityMask(
                        new DrawingBrush(new GeometryDrawing(System.Windows.Media.Brushes.Transparent, null, freeRegion)));
                }
